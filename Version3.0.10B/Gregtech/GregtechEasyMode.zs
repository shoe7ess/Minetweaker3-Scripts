...
Compressor.addRecipe(<minecraft:coal>, <ore:dustCoal>);
...
Macerator.addRecipe(<gregtech:gt.metaitem.01:5909> * 2, <ore:oreNickel>);

Macerator.addRecipe(<techreborn:crushedore:8> * 2, <techreborn:techreborn.ore:1>);
Macerator.addRecipe(<techreborn:crushedore:8> * 4, <ore:oreNetherIridium>);
Macerator.addRecipe(<techreborn:crushedore:8> * 2, <ore:oreIridium>);
Macerator.addRecipe(<techreborn:crushedore:8> * 2, <ore:oreNetherrackIridium>);
Macerator.addRecipe(<techreborn:crushedore:8> * 2, <ore:oreEndstoneIridium>);
